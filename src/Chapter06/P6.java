...
/**
 * Converts money depending on the rate that you put in
 *
 * @author Alan Kelly
 */
public class P6 {
    ...
    /**
     * convert Method takes the user input and covert it
     *
     * @param dollars the dollars being converted
     * @param exchangeRate The Exchange rate of the money
     * @return returns the converted money
     */
